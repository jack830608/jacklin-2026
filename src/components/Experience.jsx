...
const Experience = () => {
  ...
  const spaceStations = [
    {
      ...
      description:
        "Currently stationed at a cutting-edge music technology company, optimizing digital experiences and leading front-end development initiatives.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Specialized mission at a leading big data analytics company, developing sophisticated advertising platforms and implementing advanced tracking solutions.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Deployed to an innovative travel platform company, enhancing user experience through modern web technologies and optimizing performance for global travelers.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Pioneered AI-driven media solutions in a dynamic startup environment where innovation and meritocracy flourished, contributing to groundbreaking chatbot development.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Engineered comprehensive educational management systems for supplementary education institutions, integrating modern web technologies with intelligent automation.",
      achievements: [
  ...
  return (
    <section ref={ref} className="min-h-screen bg-black relative overflow-hidden lg:max-h-screen lg:overflow-hidden">
          ...
          {starData.map((star) => (
            <div
              ...
              style={{
                ...
                boxShadow:
                  star.size > 0.8
                    ? `0 0 ${star.size * 6}px white`
                    : star.size > 0.6
                    ? `0 0 ${star.size * 4}px white`
      ...
      <div className="relative z-10 min-h-screen lg:h-screen flex flex-col space-y-4 lg:space-y-[4vh] justify-center px-4 lg:px-0 py-4 lg:py-0 lg:overflow-hidden">
        {/* Header */}
        <motion.div
        ...
        >
          ...
          <p className="text-white/70 text-base max-w-2xl mx-auto">
            Journey through the cosmos of <span className="text-neon-purple">technology</span> and{" "}
            <span className="text-neon-cyan">innovation</span>
          </p>
        </motion.div>
        ...
        <div className="overflow-hidden flex-shrink-0">
          <div
            className="overflow-x-auto overflow-y-hidden timeline-container"
            style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
            onWheel={(e) => {
              // 只阻止水平滾動的冒泡，允許垂直滾動觸發 section 切換
          ...
          >
            <div
              ...
              style={{
                width: `${
                  spaceStations.length * (typeof window !== "undefined" && window.innerWidth < 768 ? 320 : 400) + 200
                }px`,
                minHeight: typeof window !== "undefined" && window.innerWidth < 768 ? "300px" : "400px",
              }}
            >
              {/* Timeline Path */}
              <div className="absolute top-1/2 left-0 right-0 h-1 transform -translate-y-1/2">
                ...
                <motion.div
                  ...
                  style={{
                    width: `${
                      spaceStations.length * (typeof window !== "undefined" && window.innerWidth < 768 ? 320 : 400) +
              ...
              {spaceStations.map((station, index) => (
                <motion.div
                  ...
                  style={{
                    width: typeof window !== "undefined" && window.innerWidth < 768 ? "300px" : "350px",
                    maxWidth: "90vw",
                  }}
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 mx-auto flex items-center justify-center">
                      {/* Orbital Rings */}
                      <motion.div
                        className="absolute w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 border border-dashed rounded-full"
                        style={{
                        ...
                        animate={{
                          rotate: 360,
                          borderColor: [`${station.color}60`, `${station.color}aa`, `${station.color}60`],
                        }}
                        transition={{
                      ...
                      />
                      <motion.div
                        className="absolute w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 border border-dashed rounded-full"
                        style={{
                        ...
                        animate={{
                          rotate: -360,
                          borderColor: [`${station.color}40`, `${station.color}80`, `${station.color}40`],
                        }}
                        transition={{
                      ...
                      {/* Central Hub */}
                      <motion.div
                        className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 rounded-full z-20 flex items-center justify-center"
                        style={{
                      ...
                      >
                        <station.icon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" style={{ color: station.color }} />
                      </motion.div>
                    </div>
                  </div>
                  ...
                  <motion.div
                    ...
                    style={{
                      borderColor: `${station.color}40`,
                      fontFamily:
                        '"Courier New", "SF Mono", "Monaco", "Inconsolata", "Fira Code", "Source Code Pro", Consolas, "Ubuntu Mono", monospace',
                    }}
                    whileHover={{
                  ...
                  >
                    ...
                    <div className="text-center mb-4">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-white mb-1">{station.company}</h3>
                      <div className="text-xs sm:text-sm font-medium mb-2" style={{ color: station.color }}>
                        {station.position}
                      </div>
                      <div className="text-xs text-white/60">{station.period}</div>
                    </div>
